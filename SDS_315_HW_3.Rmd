...
italy_doubling_time <- (70 / (italy_growth_rate *100)) * 100
...
spain_doubling_time <- (70 / (spain_growth_rate *100)) * 100
...
```
The growth rate for COVID-19 cases in Italy is `r round(italy_growth_rate,3)`. The doubling time for cases in Italy is `r round(italy_doubling_time)`.

The growth rate for COVID-19 cases in Spain is `r round(spain_growth_rate,3)`. The doubling time for cases in Spain is `r round(spain_doubling_time)`.
